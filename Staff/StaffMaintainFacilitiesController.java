...
public class StaffMaintainFacilitiesController {
    ...
    void handleSubmit(ActionEvent event)
    {
        ...
        try {
            ...
            FacilityMaintenance maintenance = new FacilityMaintenance(0, facilityId, sqlScheduledDate, taskDescription, assignedStaffId, "Completed");
